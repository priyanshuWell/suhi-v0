...
ipcMain.handle("start-weight-measurement", async () => {
  if (!biaa.biaPort || !biaa.biaPort.isOpen) {
    biaa.emitWeightStatus(0x09); // PORT_ERROR
    return { success: false };
  }
  const res =  await biaa.case41_WeightMeasurement();
...
// import * as bia from '../../bia_apporoved'
// import * as biaa from '../../biawitherrors-final'
// // BIA 
// ipcMain.handle("get-ports", async () => {
//   console.log("[MAIN] get-ports request received");
...
//   console.log("[MAIN] connect-heightPort request:", portPath);
//    await biaa.connectHeightPort(portPath);
...
//   console.log("[MAIN] Starting height measurement loop...");
//   const interval = setInterval(() => {
//     if (bia.heightPort && bia.heightPort.isOpen) {
//       console.log("[MAIN] Writing READ_CMD to height port...");
//       bia.heightPort.write(bia.READ_CMD);
