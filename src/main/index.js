...
ipcMain.handle("calculate-leg-bia", async (event, payload) => {
    try {
        ...
        const genderCode = 0
        const command = biaa.createLegsBodyCompositionCommand(
            genderCode,
            Math.round(height),
            Math.round(age),
            weight,
...
ipcMain.handle("calculate-arm-bia", async (event, payload) => {
    try {
        ...
        // const genderCode = gender === "male" ? 1 : 0
        const genderCode = 0
        const command = biaa.createArmsBodyCompositionCommand(
            genderCode,
            Math.round(height),
            Math.round(age),
            weight,
...
function convertBIADataToAPIPayload(
    ...
    return {
        ...
        age_years: (() => {
            if (!userInputs?.age) {
                console.error("[BIA CALC] age missing — cannot calculate")
                return null
            }
        ...
        final_height_cm: (() => {
            if (!userInputs?.height) {
                console.error("[BIA CALC] height missing — cannot calculate")
                return null
            }
        ...
        final_weight_kg: (() => {
            if (!userInputs?.weight) {
                console.error("[BIA CALC] weight missing — cannot calculate")
                return null
            }
        ...
        skeletal_muscle_mass_min_kg: p1.skeletalMuscleMassStandardMin || null,
        skeletal_muscle_mass_max_kg: p1.skeletalMuscleMassStandardMax || null,

        intracellular_water_kg: p1.intracellularWaterVolume || STD.icw,
        intracellular_water_min_kg: p1.intracellularWaterVolumeMin || null,
        intracellular_water_max_kg: p1.intracellularWaterVolumeMax || null,

        extracellular_water_kg: p1.extracellularWaterVolume || STD.ecw,
        extracellular_water_min_kg: p1.extracellularWaterVolumeMin || null,
        extracellular_water_max_kg: p1.extracellularWaterVolumeMax || null,
        ...
        right_hand_fat_standard: p5.segmentalFatStandards?.rightHand ?? null,
        right_hand_muscle_standard: p5.segmentalMuscleStandards?.rightHand ?? null,

        left_hand_fat_mass_kg: p2.segmentalFatMass?.leftHand || STD.armFat,
        left_hand_fat_percentage: p2.segmentalFatPercentage?.leftHand || STD.segmentalFatPct,
        left_hand_muscle_mass_kg: p2.segmentalMuscleMass?.leftHand || STD.armMuscle,
        left_hand_muscle_ratio: p2.segmentalMuscleRatio?.leftHand || STD.segmentalMuscleRatio,
        left_hand_fat_standard: p5.segmentalFatStandards?.leftHand ?? null,
        left_hand_muscle_standard: p5.segmentalMuscleStandards?.leftHand ?? null,

        trunk_fat_mass_kg: p2.segmentalFatMass?.trunk || STD.trunkFat,
        trunk_fat_percentage: p2.segmentalFatPercentage?.trunk || STD.segmentalFatPct,
        trunk_muscle_mass_kg: p2.segmentalMuscleMass?.trunk || STD.trunkMuscle,
        trunk_muscle_ratio: p2.segmentalMuscleRatio?.trunk || STD.segmentalMuscleRatio,
        trunk_fat_standard: p5.segmentalFatStandards?.trunk ?? null,
        trunk_muscle_standard: p5.segmentalMuscleStandards?.trunk ?? null,

        right_foot_fat_mass_kg: p2.segmentalFatMass?.rightFoot || STD.legFat,
        right_foot_fat_percentage: p2.segmentalFatPercentage?.rightFoot || STD.segmentalFatPct,
        right_foot_muscle_mass_kg: p2.segmentalMuscleMass?.rightFoot || STD.legMuscle,
        right_foot_muscle_ratio: p2.segmentalMuscleRatio?.rightFoot || STD.segmentalMuscleRatio,
        right_foot_fat_standard: p5.segmentalFatStandards?.rightFoot ?? null,
        right_foot_muscle_standard: p5.segmentalMuscleStandards?.rightFoot ?? null,

        left_foot_fat_mass_kg: p2.segmentalFatMass?.leftFoot || STD.legFat,
        left_foot_fat_percentage: p2.segmentalFatPercentage?.leftFoot || STD.segmentalFatPct,
        left_foot_muscle_mass_kg: p2.segmentalMuscleMass?.leftFoot || STD.legMuscle,
        left_foot_muscle_ratio: p2.segmentalMuscleRatio?.leftFoot || STD.segmentalMuscleRatio,
        left_foot_fat_standard: p5.segmentalFatStandards?.leftFoot ?? null,
        left_foot_muscle_standard: p5.segmentalMuscleStandards?.leftFoot ?? null,
        ...
        waist_hip_ratio_min: p3.waistToHipRatioStandardMin || null,
        waist_hip_ratio_max: p3.waistToHipRatioStandardMax || null,

        visceral_fat_level: p3.visceralFatLevel || STD.visceralFat,
        visceral_fat_level_min: p3.visceralFatLevelStandardMin || null,
        visceral_fat_level_max: p3.visceralFatLevelStandardMax || null,

        obesity_percentage: p3.obesityPercentage || STD.obesityPct,
        obesity_percentage_min: p3.obesityPercentageStandardMin || null,
        obesity_percentage_max: p3.obesityPercentageStandardMax || null,

        bmi: p3.bodyMassIndex || STD.bmi,
        bmi_min: p3.bodyMassIndexStandardMin || null,
        bmi_max: p3.bodyMassIndexStandardMax || null,

        body_fat_percentage: p3.bodyFatPercentage || STD.bodyFatPct,
        body_fat_percentage_min: p3.bodyFatPercentageStandardMin || null,
        body_fat_percentage_max: p3.bodyFatPercentageStandardMax || null,

        basal_metabolism_kcal: p3.basalMetabolism || STD.bmr,
        basal_metabolism_min_kcal: p3.basalMetabolismStandardMin || null,
        basal_metabolism_max_kcal: p3.basalMetabolismStandardMax || null,
        ...
        fat_control_kg: safeFatControl(p3.fatControlAmount, STD.fatControl),

        subcutaneous_fat_percentage: p3.subcutaneousFatPercentage || STD.subcutaneousFatPct,

        subcutaneous_fat_percentage_min: p3.subcutaneousFatPercentageStandardMin || null,

        subcutaneous_fat_percentage_max: p3.subcutaneousFatPercentageStandardMax || null,
