...
const GlowSlider = ({ min = 0, max = 100, value, onChange }) => {
    ...
    return (
        ...
        >
            ...
            <div
                className="absolute left-0 right-0 rounded-[24px] bg-[#01060a]"
                style={{ top: "50%", transform: "translateY(-50%)", height: "20px" }}
            />

            {/* Fill */}
            <div
                className="absolute left-0 right-0 rounded-[24px] overflow-hidden"
                style={{ top: "50%", transform: "translateY(-50%)", height: "20px" }}
            >
                <div
            ...
            <div
                ...
                style={{
                    ...
                    left: `${grabberLeft}px`,
                    background:
                        "radial-gradient(circle at 40% 35%, #b0e8ff 0%, #000 40%, #0a4060 100%)",
    ...
    return (
        <>
            ...
            {isActive && (
                ...
                >
                    <div
                        className="absolute right-[1vh] top-[6vh] landscape:top-[7vh]"
