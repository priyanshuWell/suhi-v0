            ...
            {showSymbols ? (
                ...
                <>
                    ...
                    <div className="flex gap-4">
                        <Key wide onClick={() => setShowSymbols(false)}>
                            ABC
                        </Key>
                        <Key extraWide onClick={() => onKeyPress(" ")}>
                            Space
                        </Key>
                        <Key wide onClick={onBackspace}>
                            ⌫
                        </Key>
                    </div>
                </>
                ...
                <>
                    ...
                    <div className="flex gap-4 mb-4">
                        <Key wide active={caps} onClick={() => setCaps(!caps)}>
                            Caps
                        </Key>
                    ...
                    <div className="flex gap-4">
                        <Key wide onClick={() => setShowSymbols(true)}>
                            ?123
                        </Key>
                        <Key extraWide onClick={() => onKeyPress(" ")}>
                            Space
                        </Key>
                        <Key wide onClick={onEnter}>
                            Enter
                        </Key>
                    </div>
                </>
