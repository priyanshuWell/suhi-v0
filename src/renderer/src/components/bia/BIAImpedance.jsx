...
const cardPositionStyle = (position) => {
    ...
    switch (position) {
        ...
        case "left-bottom": return { ...shared, left: "-4px", bottom: "26%" }
        case "right-bottom": return { ...shared, right: "-4px", bottom: "22%" }
...
const BiaMetricCard = ({ metric, value, isSettled, index }) => {
    ...
    return (
        <div style={cardStyle}>
            ...
            {/* icon */}
            <span style={{ fontSize: "26px", flexShrink: 0 }}>{metric.icon}</span>
        ...
        <>
            ...
            <div className="fixed inset-0 w-screen h-screen overflow-hidden bg-black">
                ...
                <div className="absolute landscape:top-15 landscape:left-[20%] portrait:top-30 portrait:left-[20%] z-10 w-[60%]">
                    <div className="relative text-center flex flex-col items-center justify-center mt-10">
                        ...
                        <img
                            src={textframe}
                            alt="text-frame"
                            className="absolute rotate-180 mb-10"
                        />
                        <p className="text-white font-medium tracking-tight landscape:text-4xl portrait:text-[46px] mt-[4rem]">
            ...
            {videoSrc && (
                <div
                    className="absolute inset-0 flex justify-center items-end mb-25 xl:items-center xl:justify-center z-10 pointer-events-none mt-[30rem]"
                    style={{ position: "absolute" }}
                >
                    {/* wrapper keeps cards relative to the video */}
                    <div style={{ position: "relative", width: "60%", display: "flex", justifyContent: "center" }}>

                        {/* ── scan beam (im screen only, during calculation) ── */}
                        {screenType === "im" && !isSettled && (
                            <div
                                style={{
                                    position: "absolute",
                                    left: "5%",
                                    ...
                                    boxShadow: "0 0 12px 3px rgba(0, 210, 255, 0.7)",
                                    animation: "biaScanLine 2s ease-in-out infinite",
                                    zIndex: 45,
                                    pointerEvents: "none",
                                }}
                            />
                        ...
                        <video
                            ...
                            loop
                            playsInline
                            className="rounded-4xl object-contain w-full rounded-2xl"
                        />
