...
const BIAResult = () => {
    ...
    const mergeWithFallback = (apiData) => {
        ...
        return {
            ...
            body_constitution:
                api?.body_constitution ?? fallbackPartialJson?.data?.body_constitution,
                ...
                <div className="relative w-full max-w-[1080px]">
                    ...
                    <div className="absolute inset-0 flex flex-col items-center pt-[18%] pb-[8%] px-[14%] text-white">
                        <div className="w-full flex justify-between gap-6 mb-8">
                            <div className="flex-1 bg-black/50 border border-cyan-500/30 rounded-3xl p-6 flex flex-col items-center justify-center backdrop-blur-md shadow-[0_0_20px_rgba(6,182,212,0.15)]">
                                <div className="flex items-center gap-3 text-cyan-400 mb-2">
                                    ...
                                    <span className="uppercase tracking-widest text-xl font-bold">
                                        {t("bia_result.weight")}
                                    </span>
                                </div>
                                <div className="text-3xl font-bold tracking-tight">
                                    {Number(finalWeight).toFixed(2) || 55}{" "}
                                    <span className="text-3xl text-gray-400 font-medium">kg</span>
                                </div>
                            </div>
                        ...
                        <div
                            ...
                            style={{
                                background:
                                    "linear-gradient(180deg, rgba(41, 171, 226, 0.05) 0%, rgba(41, 171, 226, 0.2) 100%)",
    ...
    shadow-[0_8px_30px_rgba(195,68,0,0.25)] "
                            style={{
                                background:
                                    "linear - gradient(180deg, rgba(255, 157, 92, 0.2) 0 %, rgba(255, 157, 92, 0.05) 100 %)",
