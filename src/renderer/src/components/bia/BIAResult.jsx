    ...
    const mapReportToUI = (api) => {
        ...
        return {
            ...
            learner_type: d?.learning_style
                ? {
                      type: d.learning_style.toLowerCase(),
                      title: `Your learning style is ${d.learning_style}`,
                            ...
                            {hasInsightCardsData ? (
                                ...
                                >
                                    ...
                                    {renderInsightCard({
                                        title: "Persona",
                                        icon: (
                                            <MindIcon style={{ width: "100%", height: "100%" }} />
                                        ),
                                        titleClassName: "text-[#29ABE2]",
                                        cardClassName:
                                            "bg-[linear-gradient(180deg,rgba(41,171,226,0.05)_48%,rgba(41,171,226,0.1)_70%)]",
                                        items: feelingsItems,
                                    ...
                                    {renderInsightCard({
                                        title: "Mind",
                                        icon: (
                                            <BrainIconS style={{ width: "100%", height: "100%" }} />
                                        ),
                                        titleClassName: "text-[#2CEF94]",
                                        cardClassName:
                                            "bg-[linear-gradient(180deg,rgba(44,239,148,0.05)_0%,rgba(44,239,148,0.2)_100%)]",
                                        items: learningItems,
                                    ...
                                    <div
                                        ...
                                        style={{
                                            ...
                                            background:
                                                "linear-gradient(180deg, rgba(255,157,92,0.05) 0%, rgba(255,157,92,0.2) 100%)",
                                            padding: `${S.cardPaddingV} ${S.cardPaddingH}`
                                        }}
                                    >
                                        <div
                                    ...
                                    <div
                                        ...
                                        style={{
                                            ...
                                            background:
                                                "linear-gradient(180deg, rgba(255,225,92,0.05) 0%, rgba(255,225,92,0.2) 100%)",
                                            padding: `${S.cardPaddingV} ${S.cardPaddingH}`
                                        }}
                                    >
                                        <div
                                        ...
                                        >
                                            ...
                                            >
                                                {formatLabel(
                                                    apiReport?.color_blindness?.status,
                                                    "Not present"
                                                )}
                                            </span>
                                        </div>
                                ...
                                <div className="w-full rounded-[10px] border-[0.5px] border-[#29ABE2] bg-[linear-gradient(180deg,rgba(41,171,226,0.05)_0%,rgba(41,171,226,0.1)_100%)] p-5">
                                    <div className="flex flex-col items-center justify-center gap-2.5 text-center">
                                        ...
                                        <p className="pt-0.5 text-xl tracking-wider text-white/90">
                                            {hydrationMessage}
                                        </p>
                                    </div>
                                </div>
