    ...
    return (
        ...
        >
         ...
         ══════════════════════════════════════════════════════════════ */}
                ...
                <>
                    ...
                    <div
                        style={{
                            ...
                            background:
                                "linear-gradient(145deg, rgba(12,18,32,0.98), rgba(20,10,5,0.98))",
                            ...
                            gap: "20px",
                            animation:
                                "calWarnFadeIn 0.45s cubic-bezier(0.16,1,0.3,1) forwards, calWarnPulse 2.5s ease-in-out 0.45s infinite",
                    ...
                    >
                        ...
                        <div
                            style={{
                                fontSize: "72px",
                                lineHeight: 1,
                                animation: "calWarnIcon 2s ease-in-out infinite"
                            }}
                        >
                            ⚖️
                        </div>
                        ...
                        <button
                            ...
                            style={{
                                ...
                                boxShadow:
                                    "0 0 30px rgba(255,80,0,0.4), inset 0 1px 0 rgba(255,255,255,0.15)",
                                color: "white",
            ...
            {showCalModal && (
                <CalibrationModal onClose={() => setShowCalModal(false)} onDone={handleCalDone} />
            )}
        </motion.div>
    )
}
