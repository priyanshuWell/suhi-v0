...
<svg width="351" height="31"  className={clsx("absolute h-full portrait:w-[23%] portrait:bottom-[42.5rem] portrait:right-[13rem]", horizontalLine)}  viewBox="0 0 351 31" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M0 0L33.1792 30.9945H350.314V0H0Z" fill="#9AD9FF"/>
</svg>
<svg width="28" height="692"  className={clsx("absolute h-full portrait:w-[21px] portrait:left-[13rem] portrait:bottom-20", verticleLine)}  viewBox="0 0 28 692" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M0 0V691.892L27.1996 666.415V22.9563L0 0Z" fill="#9AD9FF"/>
</svg>

<div className="absolute right-[12.5rem] bottom-[39rem]">
